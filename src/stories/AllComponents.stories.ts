        ...
        <div class="components-grid">
          <div class="category-card">
            ...
            <ul class="component-list">
              ...
              <li><a href="?path=/story/inputs-number-count--small">Number Count</a></li>
              <li><a href="?path=/story/inputs-number-select--default">Number Select</a></li>
              <li><a href="?path=/story/inputs-select--closed">Select</a></li>
              <li><a href="?path=/story/inputs-text-input--default">Text Input</a></li>
              <li><a href="?path=/story/inputs-text-select--empty">Text Select</a></li>
            </ul>
          </div>
          ...
          <div class="category-card">
            ...
            <ul class="component-list">
              ...
              <li><a href="?path=/story/selection-controls-checkbox--interactive">Checkbox</a></li>
              <li><a href="?path=/story/selection-controls-checkbox-with-label--interactive">Checkbox With Label</a></li>
              <li><a href="?path=/story/selection-controls-radio--interactive">Radio</a></li>
              <li><a href="?path=/story/selection-controls-radio-with-label--interactive">Radio With Label</a></li>
          ...
          <div class="category-card">
            <h2>Navigation</h2>
            <p>Navigation layouts, sidebars, tabs, and top bars</p>
            <ul class="component-list">
              <li><a href="?path=/docs/navigation-navigation-overview--overview">Navigation Overview</a></li>
              <li><a href="?path=/story/navigation-navigation-layout--defaultlayout">Navigation Layout</a></li>
              <li><a href="?path=/story/navigation-sidebar--collapsed">Sidebar</a></li>
              <li><a href="?path=/story/navigation-tab-item--textdefault">Tab Item</a></li>
              <li><a href="?path=/story/navigation-tabs--underlinetwoitems">Tabs</a></li>
          ...
          <div class="category-card">
            <h2>Feedback</h2>
            <p>Badges and status indicators</p>
            <ul class="component-list">
          ...
          <div class="category-card">
            ...
            <ul class="component-list">
              ...
              <li><a href="?path=/story/dropzone-upload-states--error">Upload States</a></li>
            </ul>
          </div>
